                ...
                <Form>
                  ...
                  <div className="product-category-section pb-5">
                    ...
                    <div className="examples d-flex justify-content-between mx-2">
                      <p className="exmples-paragraph sub-line-paragrpah">
                        Examples like Software project, and all
                      </p>
                      <p className="text-end sub-line-paragrpah">0/58</p>
                    </div>
                  </div>
                  ...
                  <div className="price-section pb-4">
                    <div className="show-price-section d-flex justify-content-between">
                      <h6 className="name-show-price chativa-forth chativa-fs-a">
                        Show price Range
                      </h6>
                    ...
                    {!showPrice ? (
                      <div>
                        ...
                        <p className="text-start sub-line-paragrpah ms-2">
                          Optional
                        </p>
                      </div>
                    ) : (
                      <div className=" d-flex justify-content-between">
                        ...
                        <div>
                          <Field
                            ...
                            name="d_price"
                            className="form-control input-field"
                            placeholder="Product Discounted price (INR)"
                          />
                  ...
                  <Field
                    ...
                    name="p_description"
                    className="form-control input-field"
                    placeholder="Product Discrption"
                  />
                  ...
                  <div className="d-flex">
                    ...
                    <div className="mark-as-special pt-5 ms-2">
                      ...
                      <p className="sub-line-paragrpah pt-1">
                        products marked special are shown at the top of the page
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="button-save-section text-end ">
                    ...
                    <button
                      ...
                      className=" chativa-btn chativa-btn-primary mt-5"
                    >
                      Save
                    </button>
                  </div>
